...
public class JurisdictionGrpcConfiguration {
    /*
    ...
    */
    ...
    /*
        ...
        * */
    @Bean
    public JurisdictionServiceGrpc.JurisdictionServiceBlockingStub jurisdictionServiceBlockingStub() {
        return JurisdictionServiceGrpc.newBlockingStub(channel);
    }
}
