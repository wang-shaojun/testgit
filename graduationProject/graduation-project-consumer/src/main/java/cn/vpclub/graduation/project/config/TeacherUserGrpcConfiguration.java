...
public class TeacherUserGrpcConfiguration {
    /*
    ...
    */
    ...
    /*
        ...
        * */
    @Bean
    public TeacherUserServiceGrpc.TeacherUserServiceBlockingStub teacherUserServiceBlockingStub() {
        return TeacherUserServiceGrpc.newBlockingStub(channel);
    }
}
