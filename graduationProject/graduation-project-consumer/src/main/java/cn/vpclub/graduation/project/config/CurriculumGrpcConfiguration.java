...
public class CurriculumGrpcConfiguration {
    /*
    ...
    */
    ...
    /*
        ...
        * */
    @Bean
    public CurriculumServiceGrpc.CurriculumServiceBlockingStub curriculumServiceBlockingStub() {
        return CurriculumServiceGrpc.newBlockingStub(channel);
    }
}
